...
// forward references
var localeFrom, parseAcceptLanguage, bestLanguage, format, languageFrom, normalizeLocale, gt;
...
exports.gettext = function(string) {
	if (!gt) throw new Error('i18n-abide must be initialized first');
	return gt(string);
}
