...
// forward references
var localeFrom, parseAcceptLanguage, bestLanguage, i18nformat, languageFrom;
...
exports.abide = function(options) {
  ...
  return function(req, resp, next) {
    ...
    locals.i18nformat = i18nformat;
    req.i18nformat = i18nformat;
...
/**
 * i18nformat provides string interpolation on the client and server side.
 * It can be used with either an object for named variables, or an array
 * of values for positional replacement.
 *
 * Named Example:
 * i18nformat("%(salutation)s %(place)s", {salutation: "Hello", place: "World"}, true);
 * Positional Example:
 * i18nformat("%s %s", ["Hello", "World"]);
 */
exports.i18nformat = i18nformat = function(fmt, obj, named) {
  if (!fmt) return "";
